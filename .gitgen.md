...
- **CI** - typecheck, lint, build, test on Node 20.x & 22.x
- **Release** - npm publish with provenance on version tags
- **PR Check** - spec validation, dependency review

## README Sections
1. Header with badges (CI, npm, license)
2. Brief description (git-like MCP concept)
3. Screenshot placeholder
4. Installation
5. Quick Start workflow
6. Commands summary table + detailed sections
7. .gitgen.md File Format with frontmatter fields
8. Skills section
9. .gitgen/ Directory structure
10. Cascading Configuration
11. Extensibility (providers, prompt sections, hooks)
12. MCP Server Configuration (tools table + resources)
13. GitHub Actions section
14. Contributing guidelines
15. Environment Variables (ANTHROPIC_API_KEY)
16. License
